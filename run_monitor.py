#!/usr/bin/env python
"""Run Agent 1 — Platform Monitor (Azure SQL) once."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Platform Monitor Agent (Azure SQL)")
    ...
    print("🤖  Running Platform Monitor Agent (Azure SQL)…\n")
    try:
        result = run_monitor_analysis(days=args.days, user_prompt=args.prompt)
        print(result)
    finally:
